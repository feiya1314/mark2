...
import { createLayoutControls } from './layoutControls.js';
...
import { createUntitledController } from './untitledController.js';
...
/**
 * 装配整个应用：创建所有 manager/controller/service,组装 bootstrap。
 * main.js 只负责调用本函数并在 DOMContentLoaded 时启动。
 * @returns {ReturnType<typeof createAppBootstrap>}
 */
...
const editorHistoryController = createEditorHistoryController({
    ...
    reloadKeybindings: () => {
        ...
        import('./commandSetup.js').then(({ registerDefaultKeybindings }) => {
